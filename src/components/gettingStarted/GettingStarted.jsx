...
const GettingStarted = () => {
  ...
  return (
    <div className="bg-main-body-color rounded-main p-15 w-full h-full shadow-lg flex flex-col justify-center">
      ...
      <div className="font-main-font text-sm text-black text-center">
        Already have an account? <button className="text-btn-gr no-underline font-semibold hover:underline"
        onClick={goToSignIn}
        >Sign In</button>
      </div>
    </div>
