...
const Week = () => {
  const initial = [
    { name: "Research content ideas", checked: false },
    { name: "Consult accountant", checked: false },
    { name: "Print business card", checked: false },
  ]
  ...
  return (
    <section className="rounded-tasks border border-tasks-border p-6 md:p-7 w-full h-full max-h-full flex flex-col">
      <h2 className="text-3xl font-semibold mb-4">This Week</h2>
